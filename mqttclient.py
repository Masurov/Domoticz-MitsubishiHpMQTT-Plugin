...
class MqttClient:
    ...
    def __init__(self, destination, port, clientIdPrefix, mqttConnectedCb, mqttDisconnectedCb, mqttPublishCb, mqttSubackCb):
    ...
    def Connect(self):
        ...
        if (self.mqttConn == None):
            ...
            ID = self.ClientIdPrefix + '_' + str(int(time.time()))
