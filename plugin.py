...
"""
<plugin key="MitsubishiHpMqtt" name="Mitsubishi Heatpump MQTT interface Plugin" author="Masure" version="1.41" externallink="https://github.com/Masurov/Domoticz-MitsubishiHpMQTT-Plugin">
    <description>
